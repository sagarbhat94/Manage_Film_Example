...
* 
*/
package com.manage_film_example.config;
...
import com.manage_film_example.db.manage_film_example_db.entity.User;
...
public class SwaggerConfiguration {
	...
	public Docket productApi() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.manage_film_example.controller"))
				.paths(regex("/.*")).build();
