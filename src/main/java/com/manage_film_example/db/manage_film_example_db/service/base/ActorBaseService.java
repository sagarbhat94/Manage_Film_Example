...
public class ActorBaseService {
	...
	public Actor insert(Actor obj) {
		...
		String sql = "INSERT INTO `actor` (`_id`, `birthDate`,`name`,`surname`) VALUES (:id,:birthDate,:name,:surname)";
	...
	public void delete(Long id) {
		...
		String sql_cast = "DELETE FROM `film_cast` WHERE `id_Actor`= :id";
	...
	public Actor update(Actor obj, Long id) {
		...
		String sql = "UPDATE `Actor` SET `birthDate` = :birthDate,`name` = :name,`surname` = :surname  WHERE `_id`=:id";
		SqlParameterSource parameters = new MapSqlParameterSource()
			.addValue("id", id)
			.addValue("birthDate", obj.getBirthDate())
			.addValue("name", obj.getName())
