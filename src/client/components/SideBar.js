    ...
    return (
      <Content style={styles.content}>
        <List>
          ...
          <ListItem onPress={() => this.props.navigation.navigate("ActorList")}>
            <IconMaterial
          ...
          <ListItem onPress={() => this.props.navigation.navigate("FilmList")}>
            <IconMaterial
              name="keyboard-arrow-right"
              size={20}
              style={styles.icons}
          ...
          <ListItem onPress={() => this.props.navigation.navigate("FilmMakerList")}>
            <IconMaterial
              name="keyboard-arrow-right"
              size={20}
              style={styles.icons}
